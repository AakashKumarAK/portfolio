    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            Passionate about creating innovative web applications with React.js and Next.js. Ready to contribute
            effectively to dynamic development teams.
          </motion.p>
          ...
          >
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center">
                ...
                <DropdownMenuItem asChild>
                  <a href="mailto:aakashkumar897340@gmail.com">Open in Default Email App</a>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            <a href="tel:+917904273681" className="text-muted-foreground hover:text-blue-500 transition-colors">
            ...
            <a href="https://github.com" className="text-muted-foreground hover:text-blue-500 transition-colors">
